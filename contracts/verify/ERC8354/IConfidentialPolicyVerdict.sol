...
/// or proof-attested) and ERC-8281 / ERC-8299 verify observation and input provenance
/// transparently, ERC-8354 verifies that an agent action complies with a policy that is
/// never revealed. It composes rather than competes: a domain's verifier MAY be an
/// ERC-8274 `IProofVerifier`, the agent identity is an ERC-8004 token id, and metering
/// composes with ERC-8312.
interface IConfidentialPolicyVerdict is IERC165 {
    ...
    /// EIP-712 signature (ECDSA or ERC-1271) by v.executor over verdictDigest(v).
