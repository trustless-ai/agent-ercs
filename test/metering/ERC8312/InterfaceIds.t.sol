...
import {IAggregateBudget} from "../../../contracts/metering/ERC8312/IAggregateBudget.sol";
...
contract InterfaceIdsTest is Test {
    ...
    function test_aggregateBudget_interfaceId_frozen() public pure {
        assertEq(type(IAggregateBudget).interfaceId, bytes4(0xc7cabe86));
    }
}
